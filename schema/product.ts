...
export const ProductUpdateSchema = z.object({
  ...
  priceFinished: z.coerce.number({ message: "Giá phải là số" }).min(1, { message: "Giá là bắt buộc." }).max(900000000, { message: "Giá quá cao 900,000,000." }),
  pricePhase1: z.coerce.number({ message: "Giá phải là số" }).min(1, { message: "Giá là bắt buộc." }).max(900000000, { message: "Giá quá cao 900,000,000." }),
  pricePhase2: z.coerce.number({ message: "Giá phải là số" }).min(1, { message: "Giá là bắt buộc." }).max(900000000, { message: "Giá quá cao 900,000,000." }),
