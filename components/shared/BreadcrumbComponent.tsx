...
const LinkBread = [
    ...
    { title: "Lịch sử vật liệu", href: "/dashboard/material/history", variant: "ghost" },
    { title: "Điểm danh", href: "/dashboard/attendance/update-attendance", variant: "ghost" },
    { title: "Xem điểm danh", href: "/employee/view-attendance", variant: "ghost" },
            ...
            <BreadcrumbList>
                {breadcrumbs.map((breadcrumb, index) => {
                    ...
                    return isLast ? (
                        ...
                        <BreadcrumbItem key={breadcrumb.href}>
                            <BreadcrumbLink href={breadcrumb.href}>{customTitle}</BreadcrumbLink>
                            <BreadcrumbSeparator />
                        </BreadcrumbItem>
                    );
                })}
