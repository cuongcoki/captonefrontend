...
export const UpdateShipment: React.FC<ShipmentIDProps> = ({
  ...
  const handleOffDialog = () => {
    ...
    const isFormChanged =
      JSON.stringify(initialFormValuesShipment) ===
    ...
    const isFormChanged1 =
      JSON.stringify(initialFormValuesForm) ===
      JSON.stringify(currentFormValues1);
                        ...
                        <Card>
                          ...
                          <CardContent className="space-y-2">
                            <div className=" w-full grid grid-cols-3 md:grid-cols-8 gap-4 h-[150px]  md:min-h-[100px] overflow-y-auto ">
                              {dataM.map((item) => (
                                <div
                                  className="group relative w-[60px] h-[60px] shadow-md rounded-md"
                                  key={item.id}
                                >
