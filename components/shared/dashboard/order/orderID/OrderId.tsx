    ...
    return (
        <>
            <HeaderComponent
                ...
                description="Thông tin chi tiết - trạng thái của đơn hàng."
            />
                ...
                <div className="grid sm:grid-cols-1 md:grid-cols-10 gap-6">
                    <Card className="sm:col-span-1 md:col-span-10 lg:col-span-7 shadow-sm">
                        ...
                        <TitleComponent
                                    ...
                                    description="Thông tin công ty đặt mua hàng."
                                />
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card className="sm:col-span-1 md:col-span-10 lg:col-span-3 shadow-sm">
                        <CardHeader>
                            <div className="flex justify-between items-center ">
                                <TitleComponent
                                    title="Thông tin đơn hàng"
                                    description="Thời gian - trạng thái của đơn hàng."
                                />
                        ...
                        <CardHeader>
                            <div className="flex justify-between items-center ">
                                <TitleComponent
                                    ...
                                    description="Danh sách các sản phẩm - bộ sản phẩm được đặt hàng."
                                />
