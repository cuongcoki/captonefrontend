                                                    ...
                                                    order.productOrderResponses.map(pro => (
                                                        <Card className="h-[90px]  flex gap-2 shadow-md group relative" key={pro.productId}>
                                                            <div className="group relative w-[100px] h-[90px] shadow-md rounded-md">
                                                                ...
                                                                <span className="cursor-pointer absolute bottom-0 left-0 opacity-0 group-hover:opacity-100 hover:bg-primary h-6 w-6" onClick={() => handleAddProducts(pro, pro.imageProductUrl, pro.productId, productType)}><Plus className="text-white" /></span>
                                                            </div>
                                                        ...
                                                        <TableBody className="min-h-[200px] overflow-y-auto">
                                                            {
                                                                productDetail.map((proDetail, index) => (
                                                                    <TableRow key={proDetail.itemId}>
                                                                        ...
                                                                        <TableCell>
                                                                            <span className="cursor-pointer" onClick={() => handleDeleteProducts(proDetail.itemId)}><CircleX /></span>
                                                                        </TableCell>
                                                                    </TableRow>
                                                                ))
                                                            }
