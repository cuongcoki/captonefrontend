            ...
            <Carousel className="w-full h-full flex flex-col">
                <CarouselContent className="w-full h-full">
                        ...
                        <CarouselItem className="w-full h-full flex items-center justify-center" >
                            <CardContent className="h-[350px] w-full relative flex  items-center justify-center p-6 bg-black">
                                <Image src={images} alt={`ảnh bộ sp`} width={500} height={500} className=" w-full h-full object-contain bg-cover bg-center  bg-no-repeat  pointer-events-none" />
